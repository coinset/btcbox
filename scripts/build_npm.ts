...
await build({
  ...
  package: {
    ...
    description: "Universal BTCBOX API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/btcbox.git",
    },
    bugs: {
      url: "https://github.com/coinset/btcbox/issues",
    },
    homepage: "https://github.com/coinset/btcbox#readme",
    funding: {
      type: "patreon",
